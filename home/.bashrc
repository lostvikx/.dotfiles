...
# Edit: Custom edit by ME!
# \W: Current dir
# \w: Path from home dir

if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}[\[\033[01;32m\]\u\[\033[01;37m\]@\[\033[01;31m\]\h \[\033[01;34m\]\W\[\033[00m\]] \n\$ '
else
    PS1='${debian_chroot:+($debian_chroot)}\u@\h:\W\$ '
fi
unset color_prompt force_color_prompt
...
[ -r /home/vik/.byobu/prompt ] && . /home/vik/.byobu/prompt   #byobu-prompt#

export NVM_DIR="$HOME/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm
[ -s "$NVM_DIR/bash_completion" ] && \. "$NVM_DIR/bash_completion"  # This loads nvm bash_completion

# # Customized - What the fuck is this? - vik
# bold="\e[1m" # Bold
# blue="\e[1;94m"
